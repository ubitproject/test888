#############################################################################
# Makefile for building: uBitcoin-qt
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  uBitcoin-qt.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile uBitcoin-qt.pro
#############################################################################
...
Makefile: uBitcoin-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile uBitcoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\ubits\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\ubits\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\ubits\ubitcoin-qt_plugin_import.cpp

C:/ubits/src/leveldb/libleveldb.a: FORCE
